...
export class IndexComponent extends CrudIndexBaseUtils implements OnInit {
  ...
  constructor(
    ...
    private _triprequestService: TripRequestService,
  ) {
  ...
  initializePage() {
    ...
    forkJoin([
      this._triprequestService.getStatusList(),
  ...
  search() {
    ...
    this._triprequestService.get(this.searchViewModel, this.page.orderBy, this.page.isAscending, this.page.options.currentPage, this.page.options.itemsPerPage).subscribe(response => {
