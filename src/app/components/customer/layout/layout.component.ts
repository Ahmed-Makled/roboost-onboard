...
export class CustomerLayoutComponent extends AbstractSecondLayout implements OnInit {
  page: CRUDIndexPage = new CRUDIndexPage();
  moduleID: ModuleEnum []= [ModuleEnum.CUSTOMER]
  pageID: PageEnum = PageEnum.Customers
