...
export class OrdersPerformanceComponent implements OnInit {
  ...
  getDataDay() {
    ...
    this.date = []
    this.stringDate = []
    this.customerProfileService.getCustomerOrdersLineChartByDay(this.customerID).subscribe(response => {
  ...
  getDataMonth() {
    ...
    this.month = []
    this.stringMonth = []
    this.customerProfileService.getCustomerOrdersLineChartByMonth(this.customerID).subscribe(response => {
      if (response.Success && response.Data != null) {
  ...
  getDataPieChart() {
    this.customerProfileService.getCustomerOrdersPieChart(this.customerID).subscribe(response => {
      if (response.Success) {
